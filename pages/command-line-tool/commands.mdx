...
| Command       | Description |
| :------------ | :---------: |
| [create-app](/command-line-tool/commands#create-app) | Creates a new Arke application |
| [install](/command-line-tool/commands#install) | Setup local enviroment for working with arkectl |
