...
The Arke console is the web application that simplifies your arke environment management through a user-friendly interface.
...
you can override them (e.g. required, min. length, max. length)
<br/>
...
Associate parameters to your arke to define your structure, when you associate a parameter a link is created
